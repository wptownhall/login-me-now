...
class Ajax {
	...
	public function __construct() {
		$this->action( 'wp_ajax_login_me_now_browser_token_generate', 'login_me_now_browser_token_generate' );
	...
	public function login_me_now_browser_tokens() {
		...
		$tokens = BrowserToken::init()->get_all( $offset, $limit );
	...
	public function login_me_now_browser_token_update_status() {
		...
		$updated = BrowserToken::init()->update( $token_id, $status );
	...
	public function login_me_now_browser_token_drop() {
		...
		$deleted = BrowserToken::init()->drop( $token_id );
