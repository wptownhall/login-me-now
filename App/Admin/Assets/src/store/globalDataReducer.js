const globalDataReducer = (state = {}, action) => {
  ...
  switch (actionType) {
    ...
    case "UPDATE_FACEBOOK_CLIENT_ID":
      return {
        ...state,
        enableFacebookClientID: action.payload,
      };
    ...
    case "UPDATE_SELECT_FACEBOOK_PRO_EXCLUDE_PAGES":
      return {
        ...state,
        selectFacebookProExcludePages: action.payload,
      };
